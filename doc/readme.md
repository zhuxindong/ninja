...
```shell
wget https://github.com/gngpp/ninja/releases/download/v0.8.9/ninja-0.8.9-x86_64-unknown-linux-musl.tar.gz
tar -xf ninja-0.8.9-x86_64-unknown-linux-musl.tar.gz
./ninja run
```
...
```shell
wget https://github.com/gngpp/ninja/releases/download/v0.8.9/ninja_0.8.9_aarch64_generic.ipk
wget https://github.com/gngpp/ninja/releases/download/v0.8.9/luci-app-ninja_1.1.6-1_all.ipk
wget https://github.com/gngpp/ninja/releases/download/v0.8.9/luci-i18n-ninja-zh-cn_1.1.6-1_all.ipk

opkg install ninja_0.8.9_aarch64_generic.ipk
