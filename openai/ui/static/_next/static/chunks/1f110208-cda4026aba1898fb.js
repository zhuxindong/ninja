    ...
    75927: function(e, t, r) {
        ...
        class i {
            constructor(e, t)
            {
                ...
                var h = Error(r);
                return h.name = "ParseError", h.__proto__ = i.prototype, h.position = n, h
            }
        }
        ...
        class k {
            ...
            isTrusted(e)
            {
                return e.url && !e.protocol && (e.protocol = x.protocolFromUrl(e.url)), !!("function" == typeof this.trust ? this.trust(e) : this.trust)
            }
        }
        class S {
            constructor(e, t, r)
        ...
        function G(e, t, r) {
            ...
            var a = e.charCodeAt(0),
                n = P[t][a];
            if (!n && e[0] in V && (a = V[e[0]].charCodeAt(0), n = P[t][a]), !n && "text" === r && O(a) && (n = P[t][77]), n)
                return {
                    depth: n[0],
                    height: n[1],
                    italic: n[2],
        ...
        var j = {
            ...
            Z = function(e) {
                return "string" != typeof e && (e = e.unit), e in j || e in $ || "ex" === e
            },
            K = function(e, t) {
                var r,
                    a;
            ...
            er = function(e) {
                ...
                for (var n in r && (t += ' style="' + x.escape(r) + '"'), this.attributes)
        ...
        class eo {
            ...
            toNode()
            {
                var e = document.createTextNode(this.text),
                    t = null;
                for (var r in this.italic > 0 && ((t = document.createElement("span")).style.marginRight = J(this.italic)), this.classes.length > 0 && ((t = t || document.createElement("span")).className = Q(this.classes)), this.style)
            ...
            toMarkup()
            {
                var e = !1,
                    t = "<span";
                this.classes.length && (e = !0, t += ' class="' + x.escape(Q(this.classes)) + '"');
                var r = "";
        ...
        class eh {
            ...
            toNode()
            {
                ...
                return this.alternate ? e.setAttribute("d", this.alternate) : e.setAttribute("d", L[this.pathName]), e
            }
            toMarkup()
            {
        ...
        for (var eD = "", eP = 0; eP < eH.length; eP++) {
            ...
            eg(ev, eb, eT, eF, eD),
            eP < 26 && (eg(ef, eb, ek, eF, eD = String.fromCharCode(55349, 56632 + eP)), eg(ev, eb, eT, eF, eD), eg(ef, eb, ek, eF, eD = String.fromCharCode(55349, 56476 + eP)), eg(ev, eb, eT, eF, eD))
        }
        ...
        var eW = [["mathbf", "textbf", "Main-Bold"], ["mathbf", "textbf", "Main-Bold"], ["mathnormal", "textit", "Math-Italic"], ["mathnormal", "textit", "Math-Italic"], ["boldsymbol", "boldsymbol", "Main-BoldItalic"], ["boldsymbol", "boldsymbol", "Main-BoldItalic"], ["mathscr", "textscr", "Script-Regular"], ["", "", ""], ["", "", ""], ["", "", ""], ["mathfrak", "textfrak", "Fraktur-Regular"], ["mathfrak", "textfrak", "Fraktur-Regular"], ["mathbb", "textbb", "AMS-Regular"], ["mathbb", "textbb", "AMS-Regular"], ["", "", ""], ["", "", ""], ["mathsf", "textsf", "SansSerif-Regular"], ["mathsf", "textsf", "SansSerif-Regular"], ["mathboldsf", "textboldsf", "SansSerif-Bold"], ["mathboldsf", "textboldsf", "SansSerif-Bold"], ["mathitsf", "textitsf", "SansSerif-Italic"], ["mathitsf", "textitsf", "SansSerif-Italic"], ["", "", ""], ["", "", ""], ["mathtt", "texttt", "Typewriter-Regular"], ["mathtt", "texttt", "Typewriter-Regular"]],
            ...
            e8 = {
                ...
                mathsym: function(e, t, r, a) {
                    return (void 0 === a && (a = []), "boldsymbol" === r.font && e$(e, "Main-Bold", t).metrics) ? eZ(e, "Main-Bold", t, r, a.concat(["mathbf"])) : "\\" === e || "main" === ed[t][e].font ? eZ(e, "Main-Regular", t, r, a) : eZ(e, "AMS-Regular", t, r, a.concat(["amsrm"]))
                },
                makeSpan: eQ,
                makeSvgSpan: e0,
                ...
                makeOrd: function(e, t, r) {
                    ...
                    if (o) {
                        if ("boldsymbol" === o) {
                            var m,
                                c,
                                p = "textord" !== r && e$(n, "Math-BoldItalic", a).metrics ? {
                            ...
                            s ? (m = e7[o].fontName, c = [o]) : (m = e6(o, t.fontWeight, t.fontShape), c = [o, t.fontWeight, t.fontShape]);
                        if (e$(n, m, a).metrics)
                ...
                staticSvg: function(e, t) {
                    ...
                    return s.height = n, s.style.height = J(n), s.style.width = J(a), s
                },
                svgData: e3,
                tryCombineChars: e => {
                    for (var t = 0; t < e.length - 1; t++) {
                        var r = e[t],
                            a = e[t + 1];
                        r instanceof eo && a instanceof eo && eK(r, a) && (r.text += a.text, r.height = Math.max(r.height, a.height), r.depth = Math.max(r.depth, a.depth), r.italic = a.italic, e.splice(t + 1, 1), t--)
                    }
                    return e
                }
            },
        ...
        function tk(e, t) {
            var r = tm(["base"], e, t),
                a = tm(["strut"]);
            return a.style.height = J(r.height + r.depth), r.depth && (a.style.verticalAlign = J(-r.depth)), r.children.unshift(a), r
        }
        function tS(e, t) {
            var r,
                a,
            ...
            for (var s = [], o = [], l = 0; l < i.length; l++)
                if (o.push(i[l]), i[l].hasClass("mbin") || i[l].hasClass("mrel") || i[l].hasClass("allowbreak")) {
                    ...
                    i[l].hasClass("newline") && (o.pop(), o.length > 0 && (s.push(tk(o, t)), o = []), s.push(i[l]));
            o.length > 0 && s.push(tk(o, t)),
            n ? ((a = tk(tg(n, t, !0))).classes = ["tag"], s.push(a)) : r && s.push(r);
        ...
        var tT = {
            ...
            tB = function(e, t, r) {
                return ed[t][e] && ed[t][e].replace && 55349 !== e.charCodeAt(0) && !(eB.hasOwnProperty(e) && r && (r.fontFamily && "tt" === r.fontFamily.substr(4, 2) || r.font && "tt" === r.font.substr(4, 2))) && (e = ed[t][e].replace), new tT.TextNode(e)
            },
            tC = function(e) {
            ...
            tq = function(e, t) {
                ...
                if ("mathsf" === r)
                    ...
                    return "monospace";
                var n = e.text;
                return x.contains(["\\imath", "\\jmath"], n) ? null : (ed[a][n] && ed[a][n].replace && (n = ed[a][n].replace), G(n, e8.fontMap[r].fontName, a)) ? e8.fontMap[r].variant : null
            },
            tN = function(e, t, r) {
                if (1 === e.length) {
                    var a,
                        n = tR(e[0], t);
                    return r && n instanceof tz && "mo" === n.type && (n.setAttribute("lspace", "0em"), n.setAttribute("rspace", "0em")), [n]
                }
                    ...
                    if (o instanceof tz && a instanceof tz) {
                        ...
                        if ("mi" === o.type && 1 === o.children.length && "mn" === a.type) {
                            ...
                            if (h instanceof tA && "̸" === h.text && ("mo" === o.type || "mi" === o.type || "mn" === o.type)) {
                                var m = o.children[0];
                                m instanceof tA && m.text.length > 0 && (m.text = m.text.slice(0, 1) + "̸" + m.text.slice(1), i.pop())
                            }
                        }
                    }
                    i.push(o),
        ...
        function tO(e, t, r, a, n) {
            ...
            return h.setAttribute("xmlns", "http://www.w3.org/1998/Math/MathML"), a && h.setAttribute("display", "block"), e8.makeSpan([n ? "katex" : "katex-mathml"], [h])
        }
        var tH = function(e) {
                return new _({
                ...
                svgSpan: function(e, t) {
                    var {span: r, minWidth: a, height: n} = function() {
                        ...
                        if (x.contains(["widehat", "widecheck", "widetilde", "utilde"], a)) {
                            ...
                            if (l > 5)
                                "widehat" === a || "widecheck" === a ? (n = 420, r = 2364, s = .42, i = a + "4") : (n = 312, r = 2340, s = .34, i = "tilde4");
                            else {
                                var h = [1, 1, 2, 2, 3, 3][l];
                    ...
                    return r.height = n, r.style.height = J(n), a > 0 && (r.style.minWidth = J(a)), r
                }
            };
        function tG(e, t) {
            if (!e || e.type !== t)
        ...
        var tX = (e, t) => {
                e && "supsub" === e.type ? (o = (l = tG(e.base, "accent")).base, e.base = o, h = function(e) {
                    if (e instanceof ea)
                        return e;
                    throw Error("Expected span<HtmlDomNode> but got " + String(e) + ".")
                }(tw(e, t)), e.base = l) : o = (l = tG(e, "accent")).base;
                ...
                if (l.isStretchy)
                    ...
                    "\\vec" === l.label ? (c = e8.staticSvg("vec", t), p = e8.svgData.vec[1]) : ((c = ec(c = e8.makeOrd({
                        mode: l.mode,
                        text: l.label
                    }, t, "textord"))).italic = 0, p = c.width, i && (s += c.depth)),
        ...
        ts({
            ...
            htmlBuilder(e, t) {
                ...
                e.below && (i = t.havingStyle(n.sub()), (r = e8.wrapFragment(tw(e.below, i, t), t)).classes.push(o + "-arrow-pad"));
                ...
                return a.children[0].children[0].children[1].classes.push("svg-align"), e8.makeSpan(["mrel", "x-arrow"], [a], t)
            },
            mathmlBuilder(e, t) {
                var r,
        ...
        ts({
            ...
            htmlBuilder(e, t) {
                ...
                return a.classes.push("cd-label-" + e.side), a.style.bottom = J(.8 - a.depth), a.height = 0, a.depth = 0, a
            },
            mathmlBuilder(e, t) {
        ...
        ts({
            ...
            htmlBuilder(e, t) {
                ...
                return e.newLine && (r.classes.push("newline"), e.size && (r.style.marginTop = J(K(e.size, t)))), r
            },
            mathmlBuilder(e, t) {
                var r = new tT.MathNode("mspace");
                return e.newLine && (r.setAttribute("linebreak", "newline"), e.size && r.setAttribute("height", J(K(e.size, t)))), r
            }
        });
        var t1 = {
                "\\global": "\\global",
        ...
        ts({
            ...
            handler(e) {
                ...
                var a = t.fetch();
                if (t1[a.text])
                    return ("\\global" === r || "\\\\globallong" === r) && (a.text = t1[a.text]), tG(t.parseFunction(), "internal");
        ...
        ts({
            ...
            handler(e) {
                var {parser: t, funcName: r} = e,
                    ...
                    n = t.gullet.popToken(),
                    i = t.gullet.popToken();
                return t6(t, a, i, "\\\\globalfuture" === r), t.gullet.pushToken(i), t.gullet.pushToken(n), {
                    type: "internal",
                    mode: t.mode
                }
            }
        ...
        var t7 = function(e, t, r) {
            ...
            ri = function(e, t, r, a, n, i) {
                ...
                var s,
                    ...
                    h,
                    m = "Size1-Regular";
                "\\uparrow" === e ? l = h = "⏐" : "\\Uparrow" === e ? l = h = "‖" : "\\downarrow" === e ? s = l = "⏐" : "\\Downarrow" === e ? s = l = "‖" : "\\updownarrow" === e ? (s = "\\uparrow", l = "⏐", h = "\\downarrow") : "\\Updownarrow" === e ? (s = "\\Uparrow", l = "‖", h = "\\Downarrow") : x.contains(ra, e) ? l = "∣" : x.contains(rn, e) ? l = "∥" : "[" === e || "\\lbrack" === e ? (s = "⎡", l = "⎢", h = "⎣", m = "Size4-Regular") : "]" === e || "\\rbrack" === e ? (s = "⎤", l = "⎥", h = "⎦", m = "Size4-Regular") : "\\lfloor" === e || "⌊" === e ? (l = s = "⎢", h = "⎣", m = "Size4-Regular") : "\\lceil" === e || "⌈" === e ? (s = "⎡", l = h = "⎢", m = "Size4-Regular") : "\\rfloor" === e || "⌋" === e ? (l = s = "⎥", h = "⎦", m = "Size4-Regular") : "\\rceil" === e || "⌉" === e ? (s = "⎤", l = h = "⎥", m = "Size4-Regular") : "(" === e || "\\lparen" === e ? (s = "⎛", l = "⎜", h = "⎝", m = "Size4-Regular") : ")" === e || "\\rparen" === e ? (s = "⎞", l = "⎟", h = "⎠", m = "Size4-Regular") : "\\{" === e || "\\lbrace" === e ? (s = "⎧", o = "⎨", h = "⎩", l = "⎪", m = "Size4-Regular") : "\\}" === e || "\\rbrace" === e ? (s = "⎫", o = "⎬", h = "⎭", l = "⎪", m = "Size4-Regular") : "\\lgroup" === e || "⟮" === e ? (s = "⎧", h = "⎩", l = "⎪", m = "Size4-Regular") : "\\rgroup" === e || "⟯" === e ? (s = "⎫", h = "⎭", l = "⎪", m = "Size4-Regular") : "\\lmoustache" === e || "⎰" === e ? (s = "⎧", h = "⎭", l = "⎪", m = "Size4-Regular") : ("\\rmoustache" === e || "⎱" === e) && (s = "⎫", h = "⎩", l = "⎪", m = "Size4-Regular");
                var c = t7(s, m, n),
                    p = c.height + c.depth,
                    u = t7(l, m, n),
                    d = u.height + u.depth,
            ...
            rg = function(e, t, r, a) {
                for (var n = Math.min(2, 3 - a.style.size), i = n; i < r.length && "stack" !== r[i].type; i++) {
                    var s = t7(e, rd(r[i]), "math"),
                        o = s.height + s.depth;
                    if ("small" === r[i].type && (o *= a.havingBaseStyle(r[i].style).sizeMultiplier), o > t)
                        return r[i]
                }
                return r[r.length - 1]
            },
            ...
            rv = {
                sqrtImage: function(e, t) {
                    var r,
                        ...
                        h = 0,
                        m = 0;
                    return "small" === i.type ? (m = 1e3 + 1e3 * o + 80, e < 1 ? s = 1 : e < 1.4 && (s = .7), l = (1 + o + .08) / s, h = (1 + o) / s, (r = rs("sqrtMain", l, m, o, t)).style.minWidth = "0.853em", a = .833 / s) : "large" === i.type ? (m = 1080 * rm[i.size], h = (rm[i.size] + o) / s, l = (rm[i.size] + o + .08) / s, (r = rs("sqrtSize" + i.size, l, m, o, t)).style.minWidth = "1.02em", a = 1 / s) : (l = e + o + .08, h = e + o, (r = rs("sqrtTall", l, m = Math.floor(1e3 * e + o) + 80, o, t)).style.minWidth = "0.742em", a = 1.056), r.height = h, r.style.height = J(l), {
                        span: r,
                        advanceWidth: a,
                ...
                sizedDelim: function(e, t, r, a, n) {
                    if ("<" === e || "\\lt" === e || "⟨" === e ? e = "\\langle" : (">" === e || "\\gt" === e || "⟩" === e) && (e = "\\rangle"), x.contains(ro, e) || x.contains(rh, e))
        ...
        ts({
            ...
            htmlBuilder: (e, t) => {
                ...
                for (var r, a, n = tg(e.body, t, !0, ["mopen", "mclose"]), i = 0, s = 0, o = !1, l = 0; l < n.length; l++)
                    n[l].isMiddle ? o = !0 : (i = Math.max(n[l].height, i), s = Math.max(n[l].depth, s));
                if (i *= t.sizeMultiplier, s *= t.sizeMultiplier, r = "." === e.left ? tx(t, ["mopen"]) : rv.leftRightDelim(e.left, i, s, t, e.mode, ["mopen"]), n.unshift(r), o)
        ...
        var rk = (e, t) => {
                ...
                if ("sout" === i)
                    ...
                    var d = 0,
                        g = 0,
                        f = 0;
                    /box/.test(i) ? (f = Math.max(t.fontMetrics().fboxrule, t.minRuleThickness), g = d = t.fontMetrics().fboxsep + ("colorbox" === i ? 0 : f)) : "angl" === i ? (d = 4 * (f = Math.max(t.fontMetrics().defaultRuleThickness, t.minRuleThickness)), g = Math.max(0, .25 - n.depth)) : g = d = l ? .2 : 0,
                    r = tV.encloseSpan(n, i, d, g, t),
                    /fbox|boxed|fcolorbox/.test(i) ? (r.style.borderStyle = "solid", r.style.borderWidth = J(f)) : "angl" === i && .049 !== f && (r.style.borderTopWidth = J(f), r.style.borderRightWidth = J(f)),
                    o = n.depth + g,
                ...
                return (/cancel/.test(i) && (a.height = n.height, a.depth = n.depth), /cancel/.test(i) && !l) ? e8.makeSpan(["mord", "cancel-lap"], [a], t) : e8.makeSpan(["mord"], [a], t)
            },
            rS = (e, t) => {
                var r = 0,
        ...
        var rI = function(e, t) {
                ...
                for (a = 0, s = 0; a < h || s < I.length; ++a, ++s) {
                    for (var P = I[s] || {}, F = !0; "separator" === P.type;) {
                        if (F || ((n = e8.makeSpan(["arraycolsep"], [])).style.width = J(t.fontMetrics().doubleRuleSep), R.push(n)), "|" === P.separator || ":" === P.separator) {
                    ...
                    if (!(a >= h)) {
                        var Y = void 0;
                        (a > 0 || e.hskipBeforeAndAfter) && 0 !== (Y = x.deflt(P.pregap, d)) && ((n = e8.makeSpan(["arraycolsep"], [])).style.width = J(Y), R.push(n));
                        var X = [];
                        for (r = 0; r < o; ++r) {
                            var W = m[r],
                                _ = W[a];
                        ...
                        R.push(X),
                        (a < h - 1 || e.hskipBeforeAndAfter) && 0 !== (Y = x.deflt(P.postgap, d)) && ((n = e8.makeSpan(["arraycolsep"], [])).style.width = J(Y), R.push(n))
                    }
                }
            ...
            rO = function(e, t) {
                ...
                if (e.cols && e.cols.length > 0) {
                    ...
                    for (var b = f; b < v; b++)
                        "align" === u[b].type ? (p += rR[u[b].align], g && (d += "none "), g = !0) : "separator" === u[b].type && g && (d += "|" === u[b].separator ? "solid " : "dashed ", g = !1);
        ...
        var rU = (e, t) => {
                var r = t;
                return "display" === e ? r = r.id >= N.SCRIPT.id ? r.text() : N.DISPLAY : "text" === e && r.size === N.DISPLAY.size ? r = N.TEXT : "script" === e ? r = N.SCRIPT : "scriptscript" === e && (r = N.SCRIPTSCRIPT), r
            },
            rY = (e, t) => {
                var r,
                    a,
                ...
                if (e.hasBarLine ? (e.barSize ? (n = K(e.barSize, t), a = e8.makeLineSpan("frac-line", t, n)) : a = e8.makeLineSpan("frac-line", t), n = a.height, i = a.height) : (a = null, n = 0, i = t.fontMetrics().defaultRuleThickness), u.size === N.DISPLAY.size || "display" === e.size ? (s = t.fontMetrics().num1, o = n > 0 ? 3 * i : 7 * i, l = t.fontMetrics().denom1) : (n > 0 ? (s = t.fontMetrics().num2, o = i) : (s = t.fontMetrics().num3, o = 3 * i), l = t.fontMetrics().denom2), a) {
                ...
                return r = t.havingStyle(u), h.height *= r.sizeMultiplier / t.sizeMultiplier, h.depth *= r.sizeMultiplier / t.sizeMultiplier, m = u.size === N.DISPLAY.size ? t.fontMetrics().delim1 : u.size === N.SCRIPTSCRIPT.size ? t.havingStyle(N.SCRIPT).fontMetrics().delim2 : t.fontMetrics().delim2, c = null == e.leftDelim ? tx(t, ["mopen"]) : rv.customSizedDelim(e.leftDelim, m, !0, t.havingStyle(u), e.mode, ["mopen"]), p = e.continued ? e8.makeSpan([]) : null == e.rightDelim ? tx(t, ["mclose"]) : rv.customSizedDelim(e.rightDelim, m, !0, t.havingStyle(u), e.mode, ["mclose"]), e8.makeSpan(["mord"].concat(r.sizingClasses(t)), [c, e8.makeSpan(["mfrac"], [h]), p], t)
            },
            rX = (e, t) => {
        ...
        var rj = (e, t) => {
            var r,
                ...
                n,
                i = t.style;
            "supsub" === e.type ? (r = e.sup ? tw(e.sup, t.havingStyle(i.sup()), t) : tw(e.sub, t.havingStyle(i.sub()), t), a = tG(e.base, "horizBrace")) : a = tG(e, "horizBrace");
        ...
        ts({
            ...
            mathmlBuilder: (e, t) => {
                var r = tI(e.body, t);
                return r instanceof tz || (r = new tz("mrow", [r])), r.setAttribute("href", e.href), r
            }
        }),
        ts({
            type: "href",
        ...
        ts({
            ...
            mathmlBuilder: (e, t) => {
                ...
                var a = K(e.height, t),
                    n = 0;
                if (e.totalheight.number > 0 && (n = K(e.totalheight, t) - a, r.setAttribute("valign", J(-n))), r.setAttribute("height", J(a + n)), e.width.number > 0) {
                    var i = K(e.width, t);
        ...
        ts({
            ...
            htmlBuilder: (e, t) => {
                "clap" === e.alignment ? (r = e8.makeSpan([], [tw(e.body, t)]), r = e8.makeSpan(["inner"], [r], t)) : r = e8.makeSpan(["inner"], [tw(e.body, t)]);
                var r,
                    a = e8.makeSpan(["fix"], []),
                    n = e8.makeSpan([e.alignment], [r, a], t),
                    i = e8.makeSpan(["strut"]);
                return i.style.height = J(n.height + n.depth), n.depth && (i.style.verticalAlign = J(-n.depth)), n.children.unshift(i), n = e8.makeSpan(["thinbox"], [n], t), e8.makeSpan(["mord", "vbox"], [n], t)
            },
            mathmlBuilder: (e, t) => {
        ...
        var rK = (e, t, r, a, n, i, s) => {
            ...
            rQ = (e, t) => {
                var r,
                    ...
                    i,
                    s = !1;
                "supsub" === e.type ? (r = e.sup, a = e.sub, n = tG(e.base, "op"), s = !0) : n = tG(e, "op");
                var o = t.style,
                    l = !1;
                if (o.size === N.DISPLAY.size && n.symbol && !x.contains(rJ, n.name) && (l = !0), n.symbol) {
                    var h = l ? "Size2-Regular" : "Size1-Regular",
                        m = "";
                    if (("\\oiint" === n.name || "\\oiiint" === n.name) && (m = n.name.substr(1), n.name = "oiint" === m ? "\\iint" : "\\iiint"), i = e8.makeSymbol(n.name, h, "math", t, ["mop", "op-symbol", l ? "large-op" : "small-op"]), m.length > 0) {
                        var c = i.italic,
                ...
                var f = 0,
                    v = 0;
                return ((i instanceof eo || "\\oiint" === n.name || "\\oiiint" === n.name) && !n.suppressBaseShift && (f = (i.height - i.depth) / 2 - t.fontMetrics().axisHeight, v = i.italic), s) ? rK(i, r, a, t, o, v, f) : (f && (i.style.position = "relative", i.style.top = J(f)), i)
            },
            r0 = (e, t) => {
                var r;
                if (e.symbol)
        ...
        var r5 = (e, t) => {
            var r,
                ...
                i,
                s = !1;
            if ("supsub" === e.type ? (r = e.sup, a = e.sub, n = tG(e.base, "operatorname"), s = !0) : n = tG(e, "operatorname"), n.body.length > 0) {
        ...
        ts({
            ...
            htmlBuilder(e, t) {
                ...
                return r.style.borderRightWidth = J(a), r.style.borderTopWidth = J(n), r.style.bottom = J(i), r.width = a, r.height = n + i, r.depth = -i, r.maxFontSize = 1.125 * n * t.sizeMultiplier, r
            },
            mathmlBuilder(e, t) {
                var r = K(e.width, t),
                    a = K(e.height, t),
                ...
                return n >= 0 ? o.setAttribute("height", J(n)) : (o.setAttribute("height", J(n)), o.setAttribute("depth", J(-n))), o.setAttribute("voffset", J(n)), o
            }
        });
        ...
        to({
            ...
            mathmlBuilder(e, t) {
                var r,
                    ...
                    n = tq(e, t) || "normal";
                return n !== r2[(r = "text" === e.mode ? new tT.MathNode("mtext", [a]) : /[0-9]/.test(e.text) ? new tT.MathNode("mn", [a]) : "\\prime" === e.text ? new tT.MathNode("mo", [a]) : new tT.MathNode("mi", [a])).type] && r.setAttribute("mathvariant", n), r
            }
        });
        var r9 = {
                "\\nobreak": "nobreak",
        ...
        rA["\\dots"] = function(e) {
            ...
            return r in ag ? t = ag[r] : "\\not" === r.substr(0, 4) ? t = "\\dotsb" : r in ed.math && x.contains(["bin", "rel"], ed.math[r].group) && (t = "\\dotsb"), t
        };
        var af = {
            ")": !0,
            "]": !0,
        ...
        class ax {
            ...
            consumeArg(e)
            {
                ...
                var n = this.future(),
                    ...
                    o = 0;
                do {
                    if (t = this.popToken(), r.push(t), "{" === t.text)
                        ++s;
                    else if ("}" === t.text) {
                        if (-1 == --s)
                            throw new i("Extra }", t)
        ...
        class az {
            ...
            parseSymbol()
            {
                ...
                aM.hasOwnProperty(t[0]) && !ed[this.mode][t[0]] && (this.settings.strict && "math" === this.mode && this.settings.reportNonstrict("unicodeTextInMathMode", 'Accented Unicode text character "' + t[0] + '" used in math mode', e), t = aM[t[0]] + t.substr(1));
                var s = ah.exec(t);
                if (s && ("i" === (t = t.substring(0, s.index)) ? t = "ı" : "j" === t && (t = "ȷ")), ed[this.mode][t]) {
        ...
        "undefined" != typeof document && "CSS1Compat" !== document.compatMode && ("undefined" != typeof console && console.warn("Warning: KaTeX doesn't work in quirks mode. Make sure your website has a suitable doctype."), aT = function() {
