var arkoseLabsClientApi30420e0c;
!function() {
    var e = {
        6857: function(e, t) {
            "use strict";
        ...
        7064: function(e, t, n) {
            ...
            !function() {
                ...
                e.exports = a) : "object" === o(n.amdO) && n.amdO ? void 0 === (r = function() {
                    return a
                }
        ...
        5990: function(e) {
            ...
            c.prototype.removeListener = function(e, t, r, o) {
                ...
                if (c.fn)
                    c.fn !== t || o && !c.once || r && c.context !== r || a(this, i);
                else {
        ...
        2585: function(e, t, n) {
            ...
            var o = 200
              ...
              , K = /^(?:0|[1-9]\d*)$/
              , L = {};
            L[c] = L["[object Array]"] = L[O] = L[S] = L[s] = L[u] = L[j] = L[x] = L[E] = L[_] = L[k] = L[p] = L[d] = L[v] = L[h] = L[m] = L[b] = L[g] = L[A] = L[P] = L[C] = L[T] = !0,
            L["[object Error]"] = L[l] = L[w] = !1;
            var I = "object" == (void 0 === n.g ? "undefined" : r(n.g)) && n.g && n.g.Object === Object && n.g
            ...
            var B, Z = Array.prototype, J = Function.prototype, Q = Object.prototype, Y = F["__core-js_shared__"], ee = (B = /[^.]+$/.exec(Y && Y.keys && Y.keys.IE_PROTO || "")) ? "Symbol(src)_1." + B : "", te = J.toString, ne = Q.hasOwnProperty, re = Q.toString, oe = RegExp("^" + te.call(ne).replace(/[\\^$.*+?()[\]{}|]/g, "\\$&").replace(/hasOwnProperty|(function).*?(?=\\\()| for .+?(?=\\\])/g, "$1.*?") + "$"), ie = q ? F.Buffer : void 0, ae = F.Symbol, ce = F.Uint8Array, se = G(Object.getPrototypeOf, Object), ue = Object.create, le = Q.propertyIsEnumerable, fe = Z.splice, pe = Object.getOwnPropertySymbols, de = ie ? ie.isBuffer : void 0, ve = G(Object.keys, Object), ye = He(F, "DataView"), he = He(F, "Map"), me = He(F, "Promise"), be = He(F, "Set"), ge = He(F, "WeakMap"), we = He(Object, "create"), Oe = We(ye), Se = We(he), je = We(me), xe = We(be), Ee = We(ge), _e = ae ? ae.prototype : void 0, ke = _e ? _e.valueOf : void 0;
            function Ae(e) {
                var t = -1
                  , n = e ? e.length : 0;
                for (this.clear(); ++t < n; ) {
            ...
            function Ne(e, t) {
                var n = Ge(e) || function(e) {
                  ...
                  , i = !!o;
                for (var a in e)
                    !t && !ne.call(e, a) || i && ("length" == a || ze(a, o)) || n.push(a);
                return n
            }
            function Re(e, t, n) {
                var r = e[t];
                ...
                if (w) {
                    ...
                    if (R == v || R == c || K && !i) {
                        if (W(e))
                            return i ? e : {};
                        if (y = function(e) {
                            return "function" != typeof e.constructor || Ve(e) ? {} : (t = se(e),
                            Je(t) ? ue(t) : {});
                            var t
                        }(K ? {} : e),
                        !t)
            ...
            function Ie(e) {
                return !(!Je(e) || (t = e,
                ee && ee in t)) && (Ze(e) || W(e) ? oe : R).test(We(e));
                var t
            }
            function De(e) {
                var t = new e.constructor(e.byteLength);
                return new ce(t).set(new ce(e)),
                t
            }
            function Fe(e, t, n, r) {
                n || (n = {});
            ...
            Ae.prototype.set = function(e, t) {
                return this.__data__[e] = we && void 0 === t ? i : t,
                this
            }
            ,
            ...
            Pe.prototype.delete = function(e) {
                var t = this.__data__
                  , n = Ke(t, e);
                return !(n < 0) && (n == t.length - 1 ? t.pop() : fe.call(t, n, 1),
                !0)
            }
            ,
    ...
    !function() {
        ...
        "arkose")
          ...
          , s = ("data-".concat(o, "-challenge-api-url"),
        ...
        var X = function(e) {
          ...
          , Z = function(e) {
            var t = e
              , n = G(e);
            return ("string" !== n || "string" === n && -1 === e.indexOf("px") && -1 === e.indexOf("vw") && -1 === e.indexOf("vh")) && (t = "".concat(e, "px")),
            t
        };
        function J(e) {
        ...
        var we = ["settings", "styling", "token"]
          , Oe = function e(t) {
            return "object" === ge(t) && null !== t ? Object.keys(t).reduce((function(n, r) {
                var o, i = t[r], a = ge(i), c = i;
                return -1 === we.indexOf(r) && ("string" === a && (c = "" === (o = i) ? o : (0,
                ye.N)(o)),
                "object" === a && (c = e(i))),
                me(me({}, n), {}, be({}, r, c))
            }
        ...
        var Ae = function() {
            function e() {
                ...
                this.messageListener = function() {
                    ...
                    try {
                        ...
                        if (e.data === T)
                            return void t.emitter.emit(T, {});
                        if (e.data === C)
                            return void t.emitter.emit(C, {});
            ...
            n = [{
                ...
                value: function(e, t) {
                    var n, r, o;
                    this.config.publicKey !== e && (n = window,
                    r = this.config.publicKey,
                    (o = n[R]) && o[r] && (o[r].listener && window.removeEventListener("message", o[r].listener),
        ...
        Pe.on("challenge iframe", (function(e) {
            ...
            if (Je.frame) {
                ...
                var p = !1;
                t && t !== Je.frame.style.width && (Je.frame.style.width = t,
                p = !0),
                n && n !== Je.frame.style.height && (Je.frame.style.height = n,
                p = !0),
                Je.mode === a && (r && r !== Je.frame.style["min-width"] && (Je.frame.style["min-width"] = r,
                p = !0),
                o && o !== Je.frame.style["min-height"] && (Je.frame.style["min-height"] = o,
                p = !0),
                i && i !== Je.frame.style["max-width"] && (Je.frame.style["max-width"] = i,
                p = !0),
                c && c !== Je.frame.style["max-height"] && (Je.frame.style["max-height"] = c,
                p = !0)),
                p && Pe.emit(O, {
                    width: l,
                    height: u
        ...
        var ut = $.key
          ...
          , pt = function(e, t, n) {
            ...
            try {
                "true" === window.localStorage.getItem("capiDebug") && (g = !0,
                window.capiObserver = {
                    getValues: _
                })
            } catch (e) {}
        ...
        et)
          ...
          , Pt = function() {
            ...
            return ot(ot({
                ...
                config: ot(ot({}, ut ? {
                    ...
                    selector: (e = ut,
                    "[data-".concat(o, '-public-key="').concat(e, '"]')),
            ...
            !function(e) {
                ...
                if (B(Je.element, "children", []).length < 1) {
                    var f = function(e) {
                        ...
                        host: t,
                        publicKey: n,
                        file: "1.5.4/enforcement.cd12da708fe6cbe6e068918c38de2ad9.html",
                    ...
                    Qe(Je.frame, l),
                    Je.isActive || (Je.frame.style.width = 0,
                    Je.frame.style.height = 0)
            }({
                host: lt,
          ...
          , Nt = function() {
            ...
            if (s.publicKey) {
                ...
                if (!(u - c < 100)) {
                    ...
                    Tt(),
                    o && a && (o.removeEventListener("click", a.bodyClicked),
                    ...
                    vt.element = void 0,
                    vt.element = At(s.publicKey),
                    i && l && i.contains(l) && setTimeout((function() {
                        try {
                            i.removeChild(l)
                        } catch (e) {}
                    }
          ...
          , Kt = function() {
            vt.enforcementReady && !vt.isActive && (Pe.emit(w),
            vt.isHidden && (vt.isHidden = !1,
            vt.isReady && Pe.emit(x, {
                token: vt.token
            })))
        }
          , Lt = function() {
            ...
            e && (vt.isHidden = !0),
            Ct(l, new kt(vt)),
            vt.savedActiveElement && (vt.savedActiveElement.focus(),
            vt.savedActiveElement = null),
            B(vt, "config.mode") !== a && function() {
          ...
          , It = function(e) {
            e.target.closest(vt.config.selector) && Kt()
        }
          , Dt = function(e) {
            return 27 !== B(e, "keyCode") ? null : Lt({
                manual: !0
            })
        }
          , Ft = function() {
            return B(vt, "config.mode") === a ? (vt.container = document.querySelector(B(vt, "config.selector", "")),
            void (vt.container && (vt.container.contains(vt.element) || (vt.container.appendChild(vt.element),
            Tt())))) : (vt.container = vt.bodyElement,
            vt.events.bodyClicked || (vt.events.bodyClicked = It,
            vt.bodyElement.addEventListener("click", vt.events.bodyClicked)),
            vt.events.escapePressed || (vt.events.escapePressed = Dt,
          ...
          , Ht = function() {
            var e, t = arguments.length > 0 && void 0 !== arguments[0] ? arguments[0] : {}, n = function(e) {
                return e === a ? a : "lightbox"
            }(t.mode || B(vt, "config.mode")), r = t.styleTheme || N, o = vt.isConfigured && r !== vt.config.styleTheme;
            vt.isConfigured = !0;
            ...
            t.publicKey && i !== t.publicKey && (!function(e) {
                Pe.setup(e, A),
                pt.setPublicKey(e),
                vt.element && vt.element.getAttribute && (vt.element.getAttribute("class").match(e) || vt.element.setAttribute("class", dt(e)))
            }(t.publicKey),
            i = t.publicKey,
            vt.config.publicKey && vt.config.publicKey !== t.publicKey && (c = !0)),
            vt.config = ot(ot(ot(ot({}, vt.config), t), {
                mode: n
            }), {}, {
                styleTheme: r,
                publicKey: i,
            ...
            vt.events = ot(ot({}, vt.events), {}, (ct(e = {}, yt, t[yt] || vt.events[yt]),
            ...
            o || c ? Nt(!0) : Ft(),
            "lightbox" === n && (vt.element.setAttribute("aria-modal", !0),
          ...
          , qt = function() {
            var e = arguments.length > 0 && void 0 !== arguments[0] ? arguments[0] : {}
              , t = e.event
              , n = e.observability;
            if (vt.onReadyEventCheck.push(t),
            n) {
                var r = n.timerId
                  , o = n.subTimerId
                  , i = n.time;
            ...
            )(a, vt.onReadyEventCheck).length === a.length && (vt.enforcementReady = !0,
            vt.onReadyEventCheck = [],
            vt.isCompleteReset || (pt.timerEnd(K),
            Ct(f, new kt(vt))),
        ...
        Pe.on("challenge completed", (function() {
            ...
            pt.timerEnd(I),
            Ct(u, new kt(vt)),
            B(vt, "config.mode") !== a && (vt.isCompleteReset = !0,
            Nt())
        }
        )),
        Pe.on("hide enforcement", Lt),
        Pe.on(O, (function(e) {
            var t = e.width
              , n = e.height;
            vt.width = t,
