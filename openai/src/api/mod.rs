...
pub const URL_CHATGPT_BACKEND: &str = "https://chat.openai.com/backend-api";
pub const URL_CHATGPT_PUBLIC: &str = "https://chat.openai.com/public-api";
pub const URL_API: &str = "https://api.openai.com";
