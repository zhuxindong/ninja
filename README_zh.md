...
```shell
wget https://github.com/gngpp/opengpt/releases/download/v0.2.8/opengpt_0.2.8_aarch64_generic.ipk
wget https://github.com/gngpp/opengpt/releases/download/v0.2.8/luci-app-opengpt_1.0.2-1_all.ipk
wget https://github.com/gngpp/opengpt/releases/download/v0.2.8/luci-i18n-opengpt-zh-cn_1.0.2-1_all.ipk

opkg install opengpt_0.2.8_aarch64_generic.ipk
