...
```shell
wget https://github.com/gngpp/opengpt/releases/download/v0.2.2/opengpt-0.2.2-x86_64-unknown-linux-musl.deb

dpkg -i opengpt-0.2.2-x86_64-unknown-linux-musl.deb
...
```shell
wget https://github.com/gngpp/opengpt/releases/download/v0.2.2/opengpt_0.2.2_aarch64_generic.ipk
wget https://github.com/gngpp/opengpt/releases/download/v0.2.2/luci-app-opengpt_1.0.2-1_all.ipk
wget https://github.com/gngpp/opengpt/releases/download/v0.2.2/luci-i18n-opengpt-zh-cn_1.0.2-1_all.ipk

opkg install opengpt_0.2.2_aarch64_generic.ipk
